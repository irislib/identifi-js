...
angular.module('identifiers').controller('IdentifiersController', [
  ...
  function ($scope, $stateParams, $location, Authentication, Identifiers) {
    ...
    $scope.search = function () {
      $scope.identifiers = Identifiers.query(function () {
    ...
    $scope.findOne = function () {
      $scope.identifier = Identifiers.get({
        idType: $stateParams.idType,
        idValue: $stateParams.idValue
      });
      $scope.gravatar = CryptoJS.MD5($scope.idValue).toString();
    };
  }
]);'use strict';
...
angular.module('identifiers').factory('Identifiers', [
  '$resource',
  function ($resource) {
    return $resource('id/:idType/:idValue', {
      idType: '',
      idValue: ''
    });
  }
